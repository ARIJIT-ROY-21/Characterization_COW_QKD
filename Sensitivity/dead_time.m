...
t_d = 10e-9:5e-9:15e-9; % Dead Time in detector
...
% Sensitivity Analysis of QBER under various detector Dead Time
dQdt_d = gradient(Q,t_d);
S_t_d_Q = (t_d./Q).*dQdt_d;
S1_t_d_Q = S_t_d_Q(1);  
S2_t_d_Q = S_t_d_Q(2);      
percentage_change_t_d_Q = ((S2_t_d_Q - S1_t_d_Q)/S1_t_d_Q)*100;
fprintf('Change in S_t_d_Q = %.2f %%\n', percentage_change_t_d_Q);
%% Sensitivity Analysis of SKR in Central Difference Method
% Sensitivity Analysis of SKR under various detector Dead Time
dRdt_d = gradient(R,t_d);
S_t_d_R = (t_d./R).*dRdt_d;
S1_t_d_R = S_t_d_R(1);  
S2_t_d_R = S_t_d_R(2);      
percentage_change_t_d_R = ((S2_t_d_R - S1_t_d_R)/S1_t_d_R)*100;
fprintf('Change in S_t_d_R = %.2f %%\n', percentage_change_t_d_R);