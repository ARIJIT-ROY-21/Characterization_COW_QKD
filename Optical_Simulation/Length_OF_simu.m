...
Q = (1 - V).*100./2;
% Excel data
filename = 'length_OF_simulation.xlsx';
data = readtable(filename);
length_excel = data{:,1};
Q_excel  = data{:,5};
figure;
hold on;
plot(L, Q, 'r-', 'LineWidth', 3, 'DisplayName', 'Numerical Model');
plot(length_excel, Q_excel, 'o', 'Color', [0.75 0 0.35], 'MarkerFaceColor', [0.75 0 0.35],'MarkerSize', 7, 'LineWidth', 1.5, 'DisplayName', 'Simulation Result');
