...
Q = (1 - V).*100./2;
% Excel data
filename = 'Data_line_count.xlsx';
data = readtable(filename);
L_excel = data{:,1};
total_counts_excel  = data{:,2};
figure;
plot(L, effective_counts_D_d, '--', 'Color', [0.80 0.30 0.00], 'LineWidth', 3, 'DisplayName', 'Numerical Model');
hold on;
plot(L_excel, total_counts_excel, 'o', 'Color', [0.80 0.30 0.00], 'MarkerFaceColor', [0.80 0.30 0.00],'MarkerSize', 7, 'LineWidth', 1.5, 'DisplayName', 'Simulation Result');
hold off;
